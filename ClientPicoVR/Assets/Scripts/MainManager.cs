...
public class MainManager : MonoBehaviour
{
    ...
    private void FillUI()
    {
        ...
        foreach (Transform child in UiCanvas.transform)
        {
            if (child.name == "Flag")
            {
                GroupFlag = child.GetComponent<Image>();
            }else if (child.name == "GroupSize")
            {
                GroupSizeText = child.GetComponent<Text>();
            }else if (child.name == "Role")
            {
                RoleText = child.GetComponent<Text>();
            }else if (child.name == "CountDownText")
            {
                CountDownText = child.GetComponent<Text>();
            }else if (child.name == "WaitCountDownText")
            {
                WaitCountDownText = child.GetComponent<Text>();
            }else if (child.name == "WaitSeconds")
            {
                WaitSecondsText = child.GetComponent<Text>();
            }else if (child.name == "StatusText")
            {
                StatusText = child.GetComponent<Text>();
            }else if (child.name == "TruthText")
            {
                TruthText = child.GetComponent<Text>();
            }else if (child.name == "NetworkLag")
            {
                NetworkLagText = child.GetComponent<Text>();
            }
        }
            ...
            if (localPlayer != null && localPlayerController != null)
            {
                ...
                if (localPlayerController.RotationDirty)
                {
                    ...
                    userVariables.Add(new SFSUserVariable("RotY",
                        (double) localPlayerController.Head.transform.localRotation.eulerAngles.y));
                    userVariables.Add(new SFSUserVariable("RotX",
                        (double) localPlayerController.Head.transform.localRotation.eulerAngles.x));
...
//	    userVariables.Add(new SFSUserVariable("RotY", (double)localPlayer.transform.localRotation.eulerAngles.y));
	    userVariables.Add(new SFSUserVariable("RotY", (double)localPlayerController.Head.transform.localRotation.eulerAngles.y));
        userVariables.Add(new SFSUserVariable("RotX", (double)localPlayerController.Head.transform.localRotation.eulerAngles.x));
    ...
    private void SpawnRemotePlayer(SFSUser user, Vector3 pos, Quaternion rot)
    {
        ...
        GameObject pvrCamera = Utilities.GetChildObjectWithName(remotePlayer, "Pvr_UnitySDK");
        pvrCamera.SetActive(false);
